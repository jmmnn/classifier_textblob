...
test_sources = [
            ['cybersecurity', 'legal.txt', 'legal' , 15, 5],
            ['cybersecurity', 'organizational.txt', 'organizational' , 15, 5],
            ['cybersecurity', 'technical.txt', 'technical' , 15, 5],
            ['randomText', 'random.txt', 'random' , 15, 5]
            ]

# training_sources = [
#             ['raisin', 'raisin.txt', 'raisin' , 0, 50],
#             ['santa', 'santa.txt', 'santa' , 0, 50],
#             ['randomText', 'random.txt', 'random' , 0, 50]
#             ]
#
# test_sources = [
#             ['raisin', 'raisin.txt', 'raisin' , 101, 10],
#             ['santa', 'santa.txt', 'santa' , 101, 10],
#             ['randomText', 'random.txt', 'random' , 21, 30]
#             ]
...
print ('Lenght DEV training corpus : ' , len(dev_training_Corpus))
print ('Lenght PROD training corpus : ' , len(prod_training_Corpus))
print ('Lenght TEST corpus : ' , len(test_Corpus))
...
#classifyCorpus (classifier, 'raisin')
