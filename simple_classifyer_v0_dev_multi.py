...
def createCorpora (sources , useAllData='no'):
...
test_sources = [
            ['cybersecurity', 'legal.txt', 'legal' , 11, 2],
            ['cybersecurity', 'organizational.txt', 'organizational' , 11, 2],
            ['cybersecurity', 'technical.txt', 'technical' , 11, 2],
            ['randomText', 'random.txt', 'random' , 11, 2]
            ]
